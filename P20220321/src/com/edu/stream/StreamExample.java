...
//		// this 와 student 비교 : this, student 순서(오름차순,반대 내림차순 가능) => 음수값=내림차 양수값=오름차
//		if (this.score < student.score) {
//			return -1;
//		} else {
//			return 1;
//		}
		return (this.point + this.score) - (student.point + student.score); // 60, 70 => 음수니까 내림차 / 70, 60 => 양수니까 오름차
	}
