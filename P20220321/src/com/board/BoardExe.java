...
public class BoardExe {
	public static void main(String[] args) {
		...
		while (true) {
			int menu = 0;
			System.out.println("패치노트: (admin입니다 ^^), 글 수정기능 정상화, 글자입력시 오류 수정 ");
			System.out.println("============================================================================");
			...
			if (menu == 1) {
				...
				if (tOrF == true) {
					...
					while (true) {
						System.out.println(
								"============================================================================");
						System.out.println("	");
						System.out.println(" 1.게시글 목록 2.게시글 등록 3.게시글 한건조회 4.게시글 수정 5.게시글 삭제   ~~  9.로그인 메뉴 	");
						System.out.println("	");
						System.out.println(
								"============================================================================");
						System.out.print("선택>>>>");
						...
						if (menu2 == 1) {
							...
							scn.nextLine();
							bd.setBoardTitle(scn.nextLine());
							System.out.println("게시글 내용 입력");
							bd.setBoardContents(scn.nextLine());
				...
				String um1 = scn.next();
				System.out.println("(숫자만가능함)새로 만들 비밀번호 입력>>");
				int um2 = scn.nextInt();
